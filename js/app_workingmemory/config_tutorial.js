...
//scene 0 
let text_tutorial_0_0 = "هدف این آزمایش سنجش توانایی حافظه شماست.";
let text_tutorial_0_1 = "در هر مرحله، ابتدا توالی تغییرات رنگ برای ۱۲ شیء را مشاهده خواهید کرد.";
let text_tutorial_0_2 = " وظیفه شما این است که این تغییرات را به خاطر بسپارید  "; 
let text_tutorial_0_3 = "و ترتیب نمایش آن‌ها را با کلیک بر روی دکمه‌ها گزارش دهید.";
...
//scene 2
let text_tutorial_2_0 = "وظیفه شما این است که دکمه‌ها را به ترتیب جلو که مشاهده کرده‌اید، کلیک کنید.";
